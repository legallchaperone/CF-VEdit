...
| **B4** | upstream ↔ our deltas | `third_party/` (Sa2VA, VOID/CogVideoX-Fun) is vendored and **not edited in place**; our changes live in `patches/` or new `e2w_*` files | CI: third_party has no diff |
