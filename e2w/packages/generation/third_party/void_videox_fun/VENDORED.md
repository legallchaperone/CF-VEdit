...
- **Why:** E2W v0 needs VOID's quadmask conditioning mods (`use_vae_mask`/`stack_mask` → 48-channel mask-in-latent concat) to load `void_pass1.safetensors` and reuse VOID's mask channel-concat.
